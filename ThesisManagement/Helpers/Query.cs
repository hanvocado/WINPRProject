namespace ThesisManagement.Helpers
{
    public static class Query
    {
        public static class Topic
        {
            ...
            {
                return $"UPDATE Topic SET ProfessorId='{topic.ProfessorId}', StudentId, Name, Description, Category, Technology) VALUES({topic.ProfessorId}, {topic.StudentId}, {topic.Name}, {topic.Description}, {topic.Category}, {topic.Technology})";
            }
